...
**AI Works** is a collection of reusable Claude Code skills, prompt templates, and utilities for AI-assisted professional workflows. It is **not a traditional software project** with builds, tests, or a deployed application. Instead, it houses:

1. **Reusable skills** (in `.agents/skills/` and `.claude/skills/`) — Claude Code extensions that solve specific workflows
